...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'subscription_plan', 'interval', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Plan.interval'
        raise RuntimeError("Cannot reverse this migration. 'Plan.interval' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Plan.interval'
        db.alter_column(u'subscription_plan', 'interval', self.gf('django.db.models.fields.CharField')(max_length=50))
