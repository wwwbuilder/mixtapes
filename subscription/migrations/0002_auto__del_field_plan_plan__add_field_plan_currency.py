...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Plan.plan'
        db.delete_column(u'subscription_plan', 'plan')

        # Adding field 'Plan.currency'
        db.add_column(u'subscription_plan', 'currency',
                      self.gf('django.db.models.fields.CharField')(default='usd', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Plan.plan'
        db.add_column(u'subscription_plan', 'plan',
                      self.gf('django.db.models.fields.CharField')(default='usd', max_length=50),
                      keep_default=False)

        # Deleting field 'Plan.currency'
        db.delete_column(u'subscription_plan', 'currency')
