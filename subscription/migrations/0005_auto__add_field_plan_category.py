...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plan.category'
        db.add_column(u'subscription_plan', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subscription.PlanCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plan.category'
        db.delete_column(u'subscription_plan', 'category_id')
    ...
    models = {
        ...
        u'subscription.plan': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['subscription.PlanCategory']", 'null': 'True', 'blank': 'True'}),
