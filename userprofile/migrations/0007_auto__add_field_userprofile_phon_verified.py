...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.phon_verified'
        db.add_column(u'userprofile_userprofile', 'phon_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.phon_verified'
        db.delete_column(u'userprofile_userprofile', 'phon_verified')
