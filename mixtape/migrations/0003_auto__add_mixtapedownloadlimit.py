...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MixtapeDownloadLimit'
        db.create_table(u'mixtape_mixtapedownloadlimit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'mixtape', ['MixtapeDownloadLimit'])


    def backwards(self, orm):
        # Deleting model 'MixtapeDownloadLimit'
        db.delete_table(u'mixtape_mixtapedownloadlimit')
    ...
    models = {
        ...
        u'mixtape.mixtape': {
            ...
            'releaseDatetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 29, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '200', 'blank': 'True'}),
