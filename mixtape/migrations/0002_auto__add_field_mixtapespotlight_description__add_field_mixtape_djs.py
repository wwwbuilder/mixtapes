...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MixtapeSpotLight.description'
        db.add_column(u'mixtape_mixtapespotlight', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Mixtape.djs'
        db.add_column(u'mixtape_mixtape', 'djs',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mixtape_djs', null=True, to=orm['userprofile.UserProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MixtapeSpotLight.description'
        db.delete_column(u'mixtape_mixtapespotlight', 'description')

        # Deleting field 'Mixtape.djs'
        db.delete_column(u'mixtape_mixtape', 'djs_id')
