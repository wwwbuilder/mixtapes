...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mixtape.description'
        db.alter_column(u'mixtape_mixtape', 'description', self.gf('django.db.models.fields.CharField')(max_length=160, null=True))

    def backwards(self, orm):

        # Changing field 'Mixtape.description'
        db.alter_column(u'mixtape_mixtape', 'description', self.gf('django.db.models.fields.CharField')(max_length=160))
    ...
    models = {
        ...
        u'mixtape.mixtape': {
            ...
            'releaseDatetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
