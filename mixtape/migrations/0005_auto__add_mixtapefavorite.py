...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MixtapeFavorite'
        db.create_table(u'mixtape_mixtapefavorite', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mixtape_user', to=orm['userprofile.UserProfile'])),
            ('mixtape', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mixtape', to=orm['mixtape.Mixtape'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'mixtape', ['MixtapeFavorite'])


    def backwards(self, orm):
        # Deleting model 'MixtapeFavorite'
        db.delete_table(u'mixtape_mixtapefavorite')
    ...
    models = {
        ...
        u'mixtape.mixtape': {
            ...
            'releaseDatetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '200', 'blank': 'True'}),
