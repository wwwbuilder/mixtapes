...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mixtape.producer'
        db.add_column(u'mixtape_mixtape', 'producer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mixtape_producer', null=True, to=orm['userprofile.UserProfile']),
                      keep_default=False)

        # Adding field 'Mixtape.secondaryArtist'
        db.add_column(u'mixtape_mixtape', 'secondaryArtist',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mixtape_secondaryArtist', null=True, to=orm['userprofile.UserProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mixtape.producer'
        db.delete_column(u'mixtape_mixtape', 'producer_id')

        # Deleting field 'Mixtape.secondaryArtist'
        db.delete_column(u'mixtape_mixtape', 'secondaryArtist_id')
    ...
    models = {
        ...
        u'mixtape.mixtape': {
            ...
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'description': ('django.db.models.fields.CharField', [], {'default': 'True', 'max_length': '160', 'blank': 'True'}),
            ...
            'releaseDatetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 18, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
