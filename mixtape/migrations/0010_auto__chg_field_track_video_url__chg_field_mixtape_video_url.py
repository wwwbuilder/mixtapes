...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Track.video_url'
        db.alter_column(u'mixtape_track', 'video_url', self.gf('embed_video.fields.EmbedVideoField')(max_length=200))

        # Changing field 'Mixtape.video_url'
        db.alter_column(u'mixtape_mixtape', 'video_url', self.gf('embed_video.fields.EmbedVideoField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Track.video_url'
        db.alter_column(u'mixtape_track', 'video_url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Mixtape.video_url'
        db.alter_column(u'mixtape_mixtape', 'video_url', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        u'mixtape.mixtape': {
            ...
            'releaseDatetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 14, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
