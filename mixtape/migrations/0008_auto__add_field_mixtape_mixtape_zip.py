...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mixtape.mixtape_zip'
        db.add_column(u'mixtape_mixtape', 'mixtape_zip',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mixtape.mixtape_zip'
        db.delete_column(u'mixtape_mixtape', 'mixtape_zip')
    ...
    models = {
        ...
        u'mixtape.mixtape': {
            ...
            'releaseDatetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 10, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
