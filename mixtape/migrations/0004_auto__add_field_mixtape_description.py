...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mixtape.description'
        db.add_column(u'mixtape_mixtape', 'description',
                      self.gf('django.db.models.fields.CharField')(default=True, max_length=160, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mixtape.description'
        db.delete_column(u'mixtape_mixtape', 'description')
    ...
    models = {
        ...
        u'mixtape.mixtape': {
            ...
            'releaseDatetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 11, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '200', 'blank': 'True'}),
